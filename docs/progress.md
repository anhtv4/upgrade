...
- **Buoc tiep theo (cu the):** Tao `docs/bounded-contexts.md`. Bat dau bang cau hoi: "Provider thuoc context nao - Booking hay context rieng? Tai sao?"

## Checklist Phase 1

- [x] 1. Setup git: nhanh `skeleton-reference` (skeleton tham khao) + `main` sach, push len GitHub (2026-09-23)
- [ ] 2. Doi default branch tren GitHub sang `main` (nguoi lam tu lam tren web)
